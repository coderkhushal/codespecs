  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <div class="flex  border-gray-200 py-2 my-3">
        ...
        <div class="flex border-t border-gray-200 py-2">
          ...
          <span class="ml-auto text-gray-900">1000</span>
        </div>
        <div class="flex border-t border-gray-200 py-2">
          <span class="text-gray-500">Specs</span>
          <span class="ml-auto text-gray-900">1</span>
        ...
        <div class="flex mt-5">
          <span class="title-font font-medium text-2xl text-gray-900">rs58.00</span>
