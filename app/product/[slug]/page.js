  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <input type="text" className=" border border-5 p-2 " placeholder="Enter Your Pincode" value={currentpincode} onChange={handleonchange}/>
        
        <h2 className="text-sm title-font ml-3 mb-4 py-2 text-gray-500 tracking-widest">{pincodestatus}</h2>
        </div>
